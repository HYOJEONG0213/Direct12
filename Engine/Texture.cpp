...
void Texture::Load(const wstring &path)
{
	...
	// 업로드 준비
	hr = ::PrepareUpload(DEVICE.Get(), _image.GetImages(), _image.GetImageCount(), _image.GetMetadata(), subResources);
	...
	// CPU쪽 힙의 시작 위치를 가져와서 이 위치에 실제뷰를 생성할거임.
