...
#define GRAPHICS_ROOT_SIGNATURE GEngine->GetGraphicsRootSignature()->GetGraphicsRootSignature()
#define COMPUTE_ROOT_SIGNATURE GEngine->GetGraphicsRootSignature()->GetComputeRootSignature()
